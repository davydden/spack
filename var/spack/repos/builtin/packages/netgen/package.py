...
class Netgen(AutotoolsPackage):
    ...
    url = "https://downloads.sourceforge.net/project/netgen-mesher/netgen-mesher/5.3/netgen-5.3.0.tar.gz"
    ...
    def url_for_version(self, version):
        url = "http://downloads.sourceforge.net/project/netgen-mesher/netgen-mesher/{0}/netgen-{1}.tar.gz"
